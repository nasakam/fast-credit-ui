...
$(document).ready(function () {
  ...
  $(window).click(function (event) {
    ...
    if ($(event.target).is($("#view_all")) && $("#view_all").is(":visible")) {
      $("#view_all").removeClass("show").addClass("hide"); //            resetNewCustomerForm();
    }
  ...
  $("#form_").submit(function (event) {
    ...
    if (validateInput(firstname) && validateInput(lastname) && validateInput(email) && validateInput(phonenumber) && validateInput(password)) {
  ...
  $("#viewall").click(function () {
    ...
    $("#prev").removeClass("show2").addClass("hide"); //        if (init === 1) {
  ...
  function prev_next(which) {
    $("#view_all").removeClass("show").addClass("hide"); //        if (which === "next") {
